...
namespace VoskRecognizeTTS
{
    public static class SpeechApiReflectionHelper
    {
        ...
        private const string ONE_CORE_VOICES_REGISTRY = @"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\Speech Server\v11.0\Voices"; 
        ...
        public static void InjectOneCoreVoices(this SpeechSynthesizer synthesizer)
        {
            ...
            var installedVoices = GetField(voiceSynthesizer, FIELD_INSTALLED_VOICES) as System.Collections.IList;
